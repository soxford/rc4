...
if exist('biases_i0k') == 1
    ...
    h=plot(0:255, circshift(diag(circshift(biases_i0k, -2, 2)), 1, 1));
    hold
    plot(0:255, circshift(diag(circshift(biases_conf_int_lo_i0k, -2, 2)),1,1), '--r',0:255, circshift(diag(circshift(biases_conf_int_hi_i0k, -2, 2)),1,1), '--r')
    ...
    ylabel('Experimental Bias Value ($\overline{b}^{i}_{0,i+1}$)','Interpreter','latex');
    print -depsc biases_i0ip1_graph
else
