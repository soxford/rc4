...
if exist('biases_i255k') == 1
    ...
    plot(0:255, circshift(diag(circshift(biases_i255k, -3, 2)), 1, 1), 0:255, circshift(diag(circshift(biases_conf_int_lo_i255k, -3, 2)),1,1), '--r',0:255, circshift(diag(circshift(biases_conf_int_hi_i255k, -3, 2)),1,1), '--r')
