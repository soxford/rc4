...
if exist('bayesPercentCorrectOnFirstTryPage1') == 1
    %Get the indices of the points where the thresholds are crossed
    [~, I50a] = max((bayesPercentCorrectOnFirstTryPage1 >= 0.5), [], 1);
    [~, I99a] = max((bayesPercentCorrectOnFirstTryPage1 >= 0.99), [], 1);
    [~, I50b] = max((bayesPercentCorrectOnFirstTryPage2 >= 0.5), [], 1);
    [~, I99b] = max((bayesPercentCorrectOnFirstTryPage2 >= 0.90), [], 1);
    ...
    print -depsc Bayesian_Percent_First_Try_Graph
