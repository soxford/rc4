%This script plots the experimental probabilities of the values Pr[Z_320 =
...
if exist('experimentalBiasesPage2') == 1
    ...
    plot(byteVals, experimentalBiasesPage2(64,:));%, byteVals, experimentalBiasesConfIntLoBoundPage2(64,:), '--r', byteVals, experimentalBiasesConfIntHiBoundPage2(64,:), '--r')
    ...
    ylabel('Experimental Bias Value ($b^{320}_a$)','Interpreter','latex');
    print -depsc Z_320_Distribution_Graph
else
