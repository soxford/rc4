%This script plots the experimental probabilities of the values Pr[Z_457 =
...
if exist('experimentalBiasesPage2') == 1
    ...
    plot(byteVals, experimentalBiasesPage2(200,:), byteVals, experimentalBiasesConfIntLoBoundPage2(200,:), '--r', byteVals, experimentalBiasesConfIntHiBoundPage2(200,:), '--r')
    ...
    ylabel('Experimental Bias Value ($b^{457}_a$)','Interpreter','latex');
    print -depsc Z_457_Distribution_Graph
else
