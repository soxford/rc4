%This script plots the experimental probabilities of the values Pr[Z_288 =
...
if exist('experimentalBiasesPage2') == 1
    ...
    plot(byteVals, experimentalBiasesPage2(32,:));%, byteVals, experimentalBiasesConfIntLoBoundPage2(32,:), '--r', byteVals, experimentalBiasesConfIntHiBoundPage2(32,:), '--r')
    ...
    ylabel('Experimental Bias Value ($b^{288}_a$)','Interpreter','latex');
    print -depsc Z_288_Distribution_Graph
else
