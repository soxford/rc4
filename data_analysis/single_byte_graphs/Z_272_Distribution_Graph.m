%This script plots the experimental probabilities of the values Pr[Z_272 =
...
if exist('experimentalBiasesPage2') == 1
    ...
    plot(byteVals, experimentalBiasesPage2(16,:));%, byteVals, experimentalBiasesConfIntLoBoundPage2(16,:), '--r', byteVals, experimentalBiasesConfIntHiBoundPage2(16,:), '--r')
    ...
    ylabel('Experimental Bias Value ($b^{272}_a$)','Interpreter','latex');
    print -depsc Z_272_Distribution_Graph
else
