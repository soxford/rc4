...
if exist('experimentalBiasesPage2') == 1
    ...
    h=plot(byteVals, experimentalBiasesPage2(1,:));
    hold
    plot(byteVals, experimentalBiasesConfIntLoBoundPage2(1,:), '--r', byteVals, experimentalBiasesConfIntHiBoundPage2(1,:), '--r')
    ...
    ylabel('Experimental Bias Value ($b^{257}_a$)','Interpreter','latex');
    print -depsc Z_257_Distribution_Graph
else
