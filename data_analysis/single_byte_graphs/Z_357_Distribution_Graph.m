...
if exist('experimentalBiasesPage2') == 1
    ...
    plot(byteVals, experimentalBiasesPage2(100,:), byteVals, experimentalBiasesConfIntLoBoundPage2(100,:), '--r', byteVals, experimentalBiasesConfIntHiBoundPage2(100,:), '--r')
    ...
    ylabel('Experimental Bias Value ($b^{357}_a$)','Interpreter','latex');
    print -depsc Z_357_Distribution_Graph
else
