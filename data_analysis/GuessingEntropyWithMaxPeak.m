...
%order
function [logSampleSizes,averageNoOfGuesses] = GuessingEntropyWithMaxPeak(experimentalProbs, samplecount)% Number of outcomes for each byte position, required size of the noise
% vector = k
