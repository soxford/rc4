...
const char* TEST_NAME = "Control Test for single bytes on Arcus";
...
int main(int argc, char *argv[])
{
  ...
  string fileName = "sbArcusTestData" + to_string((long long) my_proc_id) + ".txt";
