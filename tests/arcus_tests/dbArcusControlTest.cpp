/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Title: dbArcusControlTest.cpp 
 * Author: Simon Campbell, <simonhmcampbell@gmail.com>
 * Description: A control test of the doublebyte collection code for comparison to variants for the identification of bottlenecks, written for arcus-b
 * License: 
 * Date: June 2015
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
