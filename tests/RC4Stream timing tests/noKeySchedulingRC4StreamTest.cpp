/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Title: noKeySchedulingRC4Stream.cpp
 * Author: Simon Campbell, <simonhmcampbell@gmail.com>
 * Description: A timing test with no Key Scheduling behaviour
 * License: GPL
 * Date: April 2015
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
class NoKeySchedulingRC4Stream : public RC4Stream {
   public:
      NoKeySchedulingRC4Stream() : RC4Stream(){};

      ~NoKeySchedulingRC4Stream() {};
...
const char* TEST_NAME = "No Key Scheduling RC4 Stream Test";
...
int main(int argc, const char *argv[])
{
   ...
   RC4Stream *rc4Stream = new NoKeySchedulingRC4Stream();
