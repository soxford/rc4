/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Title: noPermInitRC4Stream.cpp
 * Author: Simon Campbell, <simonhmcampbell@gmail.com>
 * Description: A timing test with Key Schedule implementation that only schedules the permutation array but does not initialize it
 * License: GPL
 * Date: April 2015
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
class NoPermInitRC4Stream : public RC4Stream {
   public:
...
const char* TEST_NAME = "Permutation Scheduling without initialisation RC4 Stream Test";
...
int main(int argc, const char *argv[])
{
   ...
   RC4Stream *rc4Stream = new NoPermInitRC4Stream();
